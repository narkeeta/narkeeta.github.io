	...
	<div id="upcoming">
		...
		<div class="event">
			<div class="event-date">
				<h30>JUNE 29, 2016</h30>
				<h31>SAN FRANCISCO</h31>
			</div>
			<div class="event-info">
				<h30>CONCERT IN SAN FRANCISCO</h30>
				<h31>This is just an fake event to show the layout of the page, ignore it please!</h31>
			</div>
			<div class="event-btn">
				<a href="#" class="buybtn">REGISTER</a>
			</div>
		</div>
...
We are the future of live entertainment, the future of multimedia content. The future of experience.<br><br>We are the future of live entertainment, the future of multimedia content. The future of experience.</h3>
	...
	<div id="work">
		<div id="posters">
			<div class="poster poster-left" style="background-image:url('https://hd.unsplash.com/photo-1470848051974-964b789cb6fa')"> </div>

			<div class="poster poster-center" style="background-image:url('https://hd.unsplash.com/photo-1470229722913-7c0e2dbbafd3')"> </div>

			<div class="poster poster-right" style="background-image:url('https://hd.unsplash.com/photo-1470225620780-dba8ba36b745')"> </div>

			<div class="poster" style="background-image:url('https://hd.unsplash.com/photo-1470104240373-bc1812eddc9f')"> </div>

			<div class="poster" style="background-image:url('https://hd.unsplash.com/photo-1468930605463-659a967fc4e8')"> </div>
	...
	<div id="contact">
		...
		<div id="contact-sponsor">
			<h1 id="SUAM">LET US KNOW HOW TO GET IN TOUCH WITH YOU</h1>
			<div class="arrow-up"></div>
			<form id="msgform" action="https://formspree.io/info@5678mediagroup.com" method="POST">
				<input name="THIS PERSON WANTS TO BECOME A SPONSOR:" type="text" class="msg-input" placeholder="NAME" />
				<input name="THEIR EMAIL:" type="text" class="msg-input" placeholder="EMAIL" />
	...
	<!-- OLD CONTACT PAGE
	<div id="contact">
		<div class="aniUp contacthalf">
			<h1>
				CONTACT US
			</h1>
			<h4>1827 E. Example St.</h4>
			<h4>(555) 555-5584</h4>
		...
		<div class="aniUp contacthalf">
			...
			<form id="msgform" action="" method="POST">
				<input name="name" type="text" class="msg-input" placeholder="NAME" />
				<input name="email" type="text" class="msg-input" placeholder="EMAIL" />
				<textarea name="text" class="msg-input" placeholder="MESSAGE"></textarea>
				<input class="msg-send" type="submit" value="SEND" />
			</form>
		</div>
	</div>
-->
	...
	<div id="footer" class="container-fluid">
		...
		<div class="footer-email col-xs-4">
			...
			<form id="subform" action="https://formspree.io/info@5678mediagroup.com" method="POST">
				<input name="THIS PERSON WANTS TO BE ADDED TO THE MAILING LIST:" type="text" class="email-input" placeholder="you@example.email" />
				<input class="email-send" type="submit" value="SEND" />
			</form>

			<div class="footer-legal">
				<h5>COPYRIGHT @ ARISE MEDIA INC - NYC<br>ALL RIGHTS RESERVED // 732.318.0341</h5>
			</div>
		</div>
